...
**(FEATURE)** These implementation scripts do not require Internet or any kind of net to work, it works locally, on RMPP. <br>
The implementation scripts do not send any data outside the RMPP. All the scripts files can be examined, they are created based on the official manuals. <br>
