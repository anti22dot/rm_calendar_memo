...
See file of systemd service, where the path matters: https://github.com/anti22dot/rm_calendar_memo/blob/99898eec5ba9e86e26b640dcbc294bc0b8d367bf/rm_calendar_memo.service#L9
...
========
```
* <a name="optional2"></a> **[Optinal procedure 2 | Expand the PDF file:](#optional2)** 
...
Check the instructions from the **Use case 1 | Step D** , but in this case, only reupload the single file **430f8cdf-e2e8-412c-b7e3-5ebf3b126bff.pdf**
...
In other words, in this particular use case, I have added one page, right after the above. And here is what I can see after that above `<HASH_ID>`:
```
            {
                "id": "9004cc86-a0d0-4da6-b663-04e8987423a5",
                "idx": {
...
```
**Nineth**: Post that connect to the RMPP and execute this command to restart the `rm_calendar_memo` service:
```
